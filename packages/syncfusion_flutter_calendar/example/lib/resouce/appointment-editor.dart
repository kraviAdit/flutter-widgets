...
class AppointmentEditorState extends State<AppointmentEditor> {
              ...
              actions: <Widget>[
                IconButton(
                    ...
                    onPressed: () {
                      ...
                      //   ids: <String>[employeeCollection[_selectedResourceIndex].id.toString()]
                      // ));
                      ...
                      meetings.add(Appointment(
                          ...
                          endTime: endDate,
                          isAllDay: isAllDay,
                          subject: subject == '' ? '(No title)' : subject,
                          //  color: _colorCollection[_selectedColorIndex],
                          notes: "Test",
                          resourceIds: <String>[
                            operatoryCollection[selectedResourceIndex]
                                .id
                                .toString()
                          ]));
  ...
  String getTitle() {
    return subject.isEmpty ? 'New Appointment' : 'Appointment details';
  }
}
